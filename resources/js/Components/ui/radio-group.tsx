    ...
    return (
      <div className="flex items-center gap-2.5 select-none">
        <button
          ...
          className={cn(
            "aspect-square h-5 w-5 rounded-full border border-slate-300 bg-white transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 flex items-center justify-center shadow-soft-sm",
            isSelected && "border-emerald-700 text-emerald-700",
            className
          )}
          {...props}
        >
          {isSelected && <span className="h-2.5 w-2.5 rounded-full bg-emerald-700" />}
        </button>
