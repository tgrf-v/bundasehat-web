...
export default function PersalinanScreening() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    sessionStorage.setItem("latest_screening_result", JSON.stringify(result));
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <Badge variant="rose" className="mb-2 gap-1.5">
            ...
            <span>Screening Persalinan</span>
          </Badge>
        ...
        <Card className="border-slate-200/80 shadow-soft-lg bg-white">
          <form onSubmit={handleSubmit}>
            ...
            <CardContent className="space-y-4 pt-4">
              ...
              <div className="grid grid-cols-2 gap-4 p-3 rounded-xl bg-slate-50 border border-slate-200/60">
                <div>
